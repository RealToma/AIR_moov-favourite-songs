...
import imgAdvertising01 from "./assets/images/Stop03/Adversiting01.png";
import imgChair01 from "./assets/images/Back/chair01.png";
import imgStamp01 from "./assets/images/Stop03/stamp01.png";
    ...
    <StyledComponent>
      ...
      <BoxSecondEvent flagNextEvent={flagNextEvent ? true : false}>
        ...
        <BoxUp01>
          ...
          <TextGroup01>
            <TextTitle01>{data?.mdlData?.chiname || ""}</TextTitle01>
            <Text02>佢又代表你咩心情呢？</Text02>
          </TextGroup01>
        </BoxUp01>
